/************************************************************************************
 * @file PageLuminosity.h
 *
 * @brief Displays graph of Luminosity
 *
...
private:
	...
	void initDB();
public:
	PageLight(sf::RenderWindow* window, sf::Event* ev, std::deque<Page*>* pages, std::vector<std::string>* dbLocation);
	virtual ~PageLight();
